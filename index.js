...
app.use('/weatherForecast', require('./routes/weather_routes/weatherForecast.js'))

app.use('/messages', middleware.checkToken, require('./routes/messages.js'))

app.use('/chats', middleware.checkToken, require('./routes/chats.js'))

app.use('/friends', middleware.checkToken, require('./routes/friends.js'))

app.use('/previews', middleware.checkToken, require('./routes/previews.js'))
